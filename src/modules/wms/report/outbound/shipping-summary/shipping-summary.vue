  ...
  <div class="receiving-summary">
    ...
    <div class="grid-100 tablet-grid-100">
      ...
      <div class="grid-100 tablet-grid-100 container">
        <span class="component-title bold">Shipped Summary</span>
      </div>
    ...
    <div class="grid-100 tablet-grid-100" v-loading="loading">
      <table class="table-client" v-fixed-head>
        <thead>
          ...
          <tr>
            <th v-for="head in shippingSummaryReports.head" :key="head">
        ...
        <tbody v-for="summary in currentPageDates" :key="summary.id">
          ...
          <tr>
            <td v-for="head in shippingSummaryReports.head" :key="head">
      ...
      <pager :totalCount="shippingSummaryReports.data.length" :currentPage="paging.pageNo"
...
<style lang="scss" src="./shipping-summary.scss" />
